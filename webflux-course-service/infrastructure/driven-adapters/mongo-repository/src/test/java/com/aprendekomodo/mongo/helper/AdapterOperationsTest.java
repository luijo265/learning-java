package com.aprendekomodo.mongo.helper;

import com.aprendekomodo.mongo.CourseRepository;
import com.aprendekomodo.mongo.CourseRepositoryAdapter;
...
class AdapterOperationsTest {
    ...
    void setUp() {
        ...
        adapter = new CourseRepositoryAdapter(repository, objectMapper);
